...
class TextDataset(Dataset):
    ...
    def __getitem__(self, i):  
        ...
        for idx,x in enumerate(self.args.text_features):
            ...
            for word_idx,word in enumerate(str(self.text_features[idx][i]).split()[:self.args.block_size]):
...
def main():
    ...
    ## Other parameters
    parser.add_argument("--eval_data_file", default=None, type=str,required=False,
    ...
    parser.add_argument('--tensorboard_dir', type=str,default='saved_models/tensorboard_logs')
