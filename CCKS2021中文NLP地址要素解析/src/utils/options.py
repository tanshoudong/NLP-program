...
class Args:
    ...
    def initialize(parser: argparse.ArgumentParser):
        ...
        parser.add_argument('--bert_dir', default='./data/pre_bert/nezha-base-www',
                            help='bert dir for ernie / roberta-wwm / uer')

        parser.add_argument('--bert_type', default='pre_bert/nezha-base-www',
        ...
        # train args
        parser.add_argument('--train_epochs', default=7, type=int,
        ...
        parser.add_argument('--pseudo',default=False,action='store_true',
                            help='use pseudo or not when training')

        parser.add_argument('--cv_num', default=-1,type=int,
                            help='use cv train or not')

        parser.add_argument('--cv_infer', default=False,action='store_true',
                            help='use cv infer or not')

        parser.add_argument('--pseudo_filter', default=False, action='store_true',
                            help='filter pseudo data or not')
